...
test("A7 direct TAP is isolated and a later authoritative gate executes", () => {
  ...
  // 2026-08-20: SELF-EVAL-COLLECT-1A appends dema-self-eval-collect-check
  // directly after dema-self-eval-baseline-preview-check (MEASURED index 50),
  // ahead of the isolated TAP command: 208 -> 209, isolated 132 -> 133,
  // coverage 133 -> 134. MEASURED by importing `commands`, not arithmetic.
