...
- Imported by (non-exhaustive):
  - packages/genesis/src/* (node0-identity-proof.js, block0-*.js, core-flywheel-run-proof.js, urp-resource-status-proof.js, dema-realm-state-proof.js, keyconsent-integration-proof.js, node0-composition-manifest.js, block0-manifest.js, block0-manifest-verifier.js, ...)
  - packages/rules/src/rule-consent-replay-verification.v0.1.js
  - packages/receipts/src/verdict-*.js, consent-verify-command.js, proof-passport*.js, authorship-*.js (key-store, sign-command, verify, closeout, latest, demo)
