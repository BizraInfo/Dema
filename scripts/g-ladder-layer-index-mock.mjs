...
export const G_LADDER_LAYER_INDEX_MOCK_CONSENT =
  "GO: G-LADDER LAYER INDEX MOCK";
...
const WITNESS_RAILS = ["gitleaks", "codeql", "bizra_review_gate", "check"];
...
export function createMockGLadderLayerIndex(
  ...
  if (requireConsent !== G_LADDER_LAYER_INDEX_MOCK_CONSENT) {
    throw new Error(
      'CONSENT_REQUIRED: exact "GO: G-LADDER LAYER INDEX MOCK" required',
    );
  }
  ...
  const allLayersComplete = layers.every(
    (layer) =>
      layer.boundary_ref &&
  ...
  const body = {
    ...
    layer_index: Object.freeze({
      ...
      boundary_to_scaffold_to_mock_to_delivery_check_complete:
        allLayersComplete,
...
function normalizeLayer(layer) {
  ...
  if (
    ...
    throw new Error(
      "VALIDATION_FAILED: layer_id, layer_name, g_ring_id, and head_sha required",
    );
  }
  ...
  for (const rail of WITNESS_RAILS) {
    if (!Number.isInteger(layer.run_ids[rail]) || layer.run_ids[rail] <= 0) {
      throw new Error(
        `VALIDATION_FAILED: run_ids.${rail} must be positive integer`,
      );
    }
  }
  ...
  if (
    !Array.isArray(layer.still_blocked_invariants) ||
    layer.still_blocked_invariants.length === 0
  ) {
    throw new Error(
      "VALIDATION_FAILED: still_blocked_invariants must be non-empty array",
    );
  }
  ...
  return Object.freeze({
    ...
    still_blocked_invariants: Object.freeze([
      ...layer.still_blocked_invariants,
    ]),
  });
}
  ...
  return {
    ...
    layers: [
      layer({
        ...
        boundary_ref:
          "docs/06-adr/ADR-028-atomic-impact-receipt-lifecycle-boundary.md",
        schema_ref: "bizra.impact.atomic_receipt_lifecycle.v0.1.local",
        test_scaffold_ref:
          "tests/atomic-impact-receipt-lifecycle-boundary.test.js",
        mock_ref: "tests/atomic-impact-receipt-lifecycle-mock.test.js",
        delivery_check_marker:
          "ADR-028 atomic impact receipt lifecycle mock integrated: PASS",
      ...
      layer({
        ...
        boundary_ref:
          "docs/06-adr/ADR-029-mission-centric-state-ecosystem-boundary.md",
        schema_ref: "bizra.mission_state.ecosystem.v0.1.local",
        test_scaffold_ref:
          "tests/mission-centric-state-ecosystem-boundary.test.js",
        mock_ref: "tests/mission-centric-state-ecosystem-mock.test.js",
        delivery_check_marker:
          "ADR-029 mission-centric state ecosystem mock integrated: PASS",
      ...
      layer({
        ...
        boundary_ref:
          "docs/06-adr/ADR-030-dema-data-lake-alignment-boundary.md",
      ...
      layer({
        ...
        boundary_ref:
          "docs/06-adr/ADR-031-hybrid-mission-knowledge-graph-bok-boundary.md",
        schema_ref: "bizra.hybrid.mission.knowledge.bok.v0.1.local",
        test_scaffold_ref:
          "tests/hybrid-mission-knowledge-graph-bok-boundary.test.js",
        mock_ref: "tests/hybrid-mission-knowledge-graph-bok-mock.test.js",
        delivery_check_marker:
          "ADR-031 hybrid mission knowledge graph BoK mock integrated: PASS",
      ...
      layer({
        ...
        boundary_ref:
          "docs/06-adr/ADR-032-node0-closed-loop-digest-boundary.md",
      ...
      layer({
        ...
        boundary_ref:
          "docs/06-adr/ADR-033-layer-closure-contract-lcc6-boundary.md",
        ...
        delivery_check_marker:
          "ADR-033 Layer Closure Contract LCC-6 mock integrated: PASS",
