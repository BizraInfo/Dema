...
This file pins the canonical BIZRA proof-of-priority state on disk and on `main`. Until the OpenTimestamps attestation lands, this is the authoritative record of _which root, by which algorithm, over which named documents, on which commit._
