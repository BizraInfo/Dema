...
4. [ARCHITECTURE.md](ARCHITECTURE.md) for component boundaries.
5. [ENGINEERING_DISCIPLINE.md](ENGINEERING_DISCIPLINE.md) for engineering rules.
6. [06-adr/](06-adr/) before changing anything covered by an ADR.
7. [TESTING.md](TESTING.md) before changing tests or gates.
