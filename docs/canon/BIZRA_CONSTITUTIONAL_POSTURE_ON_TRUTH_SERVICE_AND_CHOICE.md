...
- **Companion:** `docs/00-product-thesis/NODE0_IGNITION_1A_IGNITION_PACK.md` (the Genesis Convergence program that operationalizes this posture); receipt `docs/receipts/BIZRA_GENESIS_CONVERGENCE_CANON_0A.md`. The master roadmap companion is `docs/00-product-thesis/BIZRA_MASTER_ROADMAP_v0_1.md` (`PLANNING_ONLY`; receipt `docs/receipts/BIZRA_MASTER_ROADMAP_0A.md`).
