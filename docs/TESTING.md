...
| `tests/process-value-preview.test.js` | Process Value Preview pure module, process RSI, SNR value, true-value scoring, fail-closed inputs, and no-runtime boundary. |
