...
| DEMA (face) — surfaced by P7 Integrator/Nexus | `dema-console/`, `bizra-omega/target/release/dema`, `bizra-omega/bizra-cognition-gateway/src/bin/dema.rs` | Single surface the human talks to.                                                                                                 |
| PAT-7, Personal Agentic Team   | `bizra-omega/bizra-core/src/topology_canon.rs`                                                            | Seven agents on the human's hardware: P1 Planner, P2 Researcher, P3 Coder, P4 Evaluator, P5 Ethicist, P6 Publisher, P7 Integrator/Nexus (DEMA is the face it surfaces). |
