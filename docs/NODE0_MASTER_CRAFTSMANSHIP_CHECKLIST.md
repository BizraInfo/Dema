...
| Canonical receipt chain            | `PARTIAL`        | `tests/canonical-receipt.test.js`, `tests/canonical-ledger.test.js`                           | Bind the full flywheel to the canonical ledger and leave legacy flat receipts clearly labeled.                                                               |
