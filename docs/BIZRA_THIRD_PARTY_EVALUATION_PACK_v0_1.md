...
| Dema CLI surfaces (`dema status`, `dema mission draft`, `dema receipts`, first-run wizard)                          | `apps/cli/` source + 4861 tests                                                                     | cloning the repo and running `npm test`                                         |
...
| Test suite (4861 tests)                                                                                             | `tests/` + CI green on Node 20.x and 22.x                                                           | running `npm test` or reading the latest PR's check results                     |
...
| `npm test`                                   | 4861 tests (Node 20.x and 22.x in CI)                                     | running it                                       |
...
| -------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| Test suite size            | **4861 tests** (last passing run)                                                           | `npm test`                                                                                                         |
| Test runner                | Node native `node --test` (no external test framework)                                      | `package.json` `scripts.test`                                                                                      |
| Coverage thresholds        | declared: 95% lines / 85% branches / 95% functions                                          | `package.json` `scripts.coverage`                                                                                  |
...
- [ ] Run `npm test`. Confirm 4861/4861 pass.
...
- **Test coverage may not extend to all canon-described surfaces**: the 4861 tests cover the implemented Dema surfaces; the designed (not-live) surfaces have no tests because they have no runtime.
