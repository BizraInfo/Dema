...
function isApprovedPreview(missionLoopPreview) {
  if (!missionLoopPreview || typeof missionLoopPreview !== "object") return false;
  if (missionLoopPreview.schema !== "bizra.dema.mission_loop_preview.v0.1") return false;
...
export const EVIDENCE_CHAIN_EVENT_REQUIRED_BLOCKED_EFFECTS = REQUIRED_BLOCKED_EFFECTS;
