...
export const PROCESS_VALUE_FIXTURE_PACK_SCHEMA =
  "bizra.dema.process_value_fixture_pack_preview.v0.1";
...
const DEFAULT_FIXTURES = [
  ...
  },
  {
    ...
    proofSignals: [
      { id: "step7_command_path", status: "passed" },
  ...
  },
  {
    ...
    proofSignals: [
      { id: "fixture", status: "passed" },
      { id: "refusal_matrix", status: "passed" },
    ],
...
const MICRO_COMPLIANCE = Object.freeze([
  Object.freeze({
    control: "no_cli_wiring",
    verified_by: "boundary.cli_wired === false",
  }),
  Object.freeze({
    control: "no_runtime_or_socket",
    verified_by:
      "boundary.runtime_started === false && boundary.socket_opened === false",
  }),
  Object.freeze({
    control: "no_node_connection",
    verified_by: "boundary.node_connection_attempted === false",
  }),
  Object.freeze({
...
const ANALOGICAL_MODEL = Object.freeze({
  ...
  useful_because:
    "fixed cards can replay known evidence states without changing the machine being measured",
...
const SELF_CRITIQUE = Object.freeze([
  ...
  Object.freeze({
    ...
    mitigation:
      "compare default fixture outputs against module-owned golden expectations",
  }),
  Object.freeze({
    risk: "malformed inner fixture could be confused with malformed pack shape",
    mitigation:
      "use distinct fixture-level preview_reject and pack-level PREVIEW_REJECT states",
  }),
]);
...
function validateFixtures(fixtures) {
  ...
  for (const fixture of fixtures) {
    ...
    if (!Object.hasOwn(EXPECTED_BY_ID, fixture.id))
      return { ok: false, reason: "fixture_id_not_allowlisted" };
    if (!Array.isArray(fixture.processEvents))
      return { ok: false, reason: "fixture_process_events_must_be_array" };
    if (!Array.isArray(fixture.proofSignals))
      return { ok: false, reason: "fixture_proof_signals_must_be_array" };
    if (!Array.isArray(fixture.blockers))
      return { ok: false, reason: "fixture_blockers_must_be_array" };
    if (!validNow(fixture.now))
      return { ok: false, reason: "fixture_now_must_be_iso_datetime" };
  }
...
export function buildProcessValueFixturePackPreview({
