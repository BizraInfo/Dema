export const NODE0_HOMEBASE_STATE_PREVIEW_SCHEMA =
  "bizra.dema.node0_homebase_state_preview.v0.1";
...
const SAT_REGISTRY = Object.freeze([
  Object.freeze({
    id: "SAT-1",
    role: "consent_verifier",
    verdict_surface: "PERMIT|REJECT|REVIEW|SCORE_ONLY",
  }),
  Object.freeze({
    id: "SAT-2",
  ...
  Object.freeze({
    id: "SAT-3",
    role: "ihsan_floor_checker",
    verdict_surface: "PERMIT|REJECT|REVIEW|SCORE_ONLY",
  }),
  Object.freeze({
    id: "SAT-4",
    role: "evidence_chain_validator",
    verdict_surface: "PERMIT|REJECT|REVIEW|SCORE_ONLY",
  }),
  Object.freeze({
    id: "SAT-5",
    role: "step7_gate_keeper",
    verdict_surface: "PERMIT|REJECT|REVIEW|SCORE_ONLY",
  }),
]);
