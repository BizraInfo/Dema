...
export const COLORS = Object.freeze({
  ...
  MIDNIGHT: Object.freeze({
    rgb: [20, 20, 35],
    hex: "#141423",
    desc: "Panel background",
  }),
  TWILIGHT: Object.freeze({
    rgb: [30, 30, 50],
    hex: "#1E1E32",
    desc: "Highlighted background",
  }),
  ...
  IHSAN: Object.freeze({
    rgb: [212, 175, 55],
    hex: "#D4AF37",
    desc: "Excellence threshold met (= GOLD)",
  }),
  ACTIVE: Object.freeze({
    rgb: [80, 200, 120],
    hex: "#50C878",
    desc: "Active · success (= EMERALD)",
  }),
  ...
  DANGER: Object.freeze({
    rgb: [220, 53, 69],
    hex: "#DC3545",
    desc: "Error · violation",
  }),
  MUTED: Object.freeze({
    rgb: [108, 117, 125],
    hex: "#6C757D",
    desc: "Inactive · disabled",
  }),

  // PAT-7 (each agent has a signature color)
  PAT_STRATEGIST: Object.freeze({
    rgb: [147, 112, 219],
    hex: "#9370DB",
    desc: "Purple · Strategy",
  }),
  PAT_RESEARCHER: Object.freeze({
    rgb: [70, 130, 180],
    hex: "#4682B4",
    desc: "Steel Blue · Knowledge",
  }),
  PAT_DEVELOPER: Object.freeze({
    rgb: [34, 139, 34],
    hex: "#228B22",
    desc: "Forest Green · Code",
  }),
  PAT_ANALYST: Object.freeze({
    rgb: [255, 140, 0],
    hex: "#FF8C00",
    desc: "Dark Orange · Data",
  }),
  PAT_REVIEWER: Object.freeze({
    rgb: [178, 34, 34],
    hex: "#B22222",
    desc: "Firebrick · Quality",
  }),
  PAT_EXECUTOR: Object.freeze({
    rgb: [70, 70, 70],
    hex: "#464646",
    desc: "Dark Gray · Action",
  }),
  PAT_GUARDIAN: Object.freeze({
    rgb: [212, 175, 55],
    hex: "#D4AF37",
    desc: "Gold · Protection (= GOLD)",
  }),

  // Voice
  VOICE_ACTIVE: Object.freeze({
    rgb: [138, 43, 226],
    hex: "#8A2BE2",
    desc: "BlueViolet · Speaking",
  }),
  VOICE_LISTENING: Object.freeze({
    rgb: [0, 191, 255],
    hex: "#00BFFF",
    desc: "DeepSkyBlue · Listening",
  }),
});
...
export const BORDERS = Object.freeze({
  ...
  ARABIC: Object.freeze({
    ...
    h: "─",
    v: "│",
    desc: "Arabic-inspired (same as STANDARD)",
  }),
});
...
function ansiForColor(color, opts = {}) {
  ...
  const idx =
    (r > 127 ? 1 : 0) | ((g > 127 ? 1 : 0) << 1) | ((b > 127 ? 1 : 0) << 2);
...
export const Theme = Object.freeze({
  ...
  subtitle: (text, opts) =>
    paint(text, COLORS.PEARL, { italic: true, ...opts }),
  ...
  patAgentActive: (role, text, opts) =>
    paint(text, patColorFor(role), { bold: true, underline: true, ...opts }),

  // Status
  statusActive: (text, opts) =>
    paint(text, COLORS.ACTIVE, { bold: true, ...opts }),
  statusPending: (text, opts) => paint(text, COLORS.WARNING, opts),
  statusError: (text, opts) =>
    paint(text, COLORS.DANGER, { bold: true, ...opts }),

  // Voice
  voiceActive: (text, opts) =>
    paint(text, COLORS.VOICE_ACTIVE, { bold: true, ...opts }),
  voiceListening: (text, opts) =>
    paint(text, COLORS.VOICE_LISTENING, { bold: true, ...opts }),
});
...
export function paint(text, color, opts = {}) {
  ...
  if (opts.italic) {
    pre = ITALIC_ON + pre;
    post = post + ITALIC_OFF;
  }
  if (opts.underline) {
    pre = UNDERLINE_ON + pre;
    post = post + UNDERLINE_OFF;
  }
  return pre + s + post;
}
