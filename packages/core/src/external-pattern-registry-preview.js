...
export const EXTERNAL_PATTERN_REGISTRY_PREVIEW_SCHEMA = "bizra.dema.external_pattern_registry_preview.v0.1";

const SAFETY_PRINCIPLE = "Authority is never imported. Only patterns are.";
const NOTE = "Borrow pattern, reject hidden authority. Every entry remains preview-only.";
...
const PATTERN_RECORDS = Object.freeze([
  ...
  Object.freeze({
    ...
    sat_verdict_required: "REVIEW",
    evidence_schemas_required: Object.freeze(["bizra.dema.consent_plan_preview.v0.1"]),
    effects_declared: Object.freeze(["read"]),
    effects_denied: Object.freeze(["write", "execute", "call"]),
    current_status: "PLANNED",
    blocked_by: Object.freeze([
  ...
  Object.freeze({
    ...
    micro_consent_field_required: "action",
    sat_verdict_required: "REVIEW",
    evidence_schemas_required: Object.freeze(["bizra.dema.evidence_chain_preview.v0.1"]),
    effects_declared: Object.freeze(["read"]),
  ...
  Object.freeze({
    ...
    sat_verdict_required: "REVIEW",
    evidence_schemas_required: Object.freeze(["bizra.dema.amana_contracts_preview.v0.1"]),
    effects_declared: Object.freeze(["read"]),
    effects_denied: Object.freeze(["write", "execute", "call"]),
  ...
  Object.freeze({
    ...
    micro_consent_field_required: "mission_id",
    sat_verdict_required: "REVIEW",
    evidence_schemas_required: Object.freeze(["bizra.dema.shared_urp_world_preview.v0.1"]),
    effects_declared: Object.freeze(["read"]),
    effects_denied: Object.freeze(["write", "execute", "call"]),
    current_status: "PREVIEW",
    blocked_by: Object.freeze([])
  ...
  Object.freeze({
    ...
    micro_consent_field_required: null,
    sat_verdict_required: "REVIEW",
    evidence_schemas_required: Object.freeze(["bizra.dema.true_value_preview.v0.1"]),
    effects_declared: Object.freeze(["read"]),
    effects_denied: Object.freeze(["write", "execute", "call"]),
    current_status: "PREVIEW",
    blocked_by: Object.freeze([])
